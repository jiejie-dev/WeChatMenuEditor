...
<div class="display_box container">
	<div class="control_panel container">
		<button class="btn btn-default" id="btnLoadRemote">加载公众平台微信菜单</button>
		<button class="btn btn-default" id="btnLoadLocal">加载本地缓存菜单</button>
		<button class="btn btn-default" id="btnClearLocal">清空本地缓存菜单</button>
...
<div class="designer container">
	...
	<div class="footer_btn_box col-md-12">
		...
		<button class="btn btn-primary" id="saveAndCreate">保存并发布</button>
	</div>	
</div>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-footer">
            ...
            <button type="button" id="modalSaveTopMenuItem" class="btn btn-primary">
               保存
            </button>
         </div>
      </div><!-- /.modal-content -->
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-footer">
            ...
            <button type="button" id="modalSaveSubMenuItem" class="btn btn-primary">
               保存
            </button>
         </div>
      </div><!-- /.modal-content -->
